...
const HomeDesign = () => {
    return (
        <div>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-3 mb-8'>
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    <figure><img className='h-[250px]' src="https://img.etimg.com/thumb/width-1200,height-900,imgsize-8316,resizemode-1,msid-94966874/industry/cons-products/electronics/bring-home-the-fully-loaded-vivo-v25-and-capture-your-festive-season-shenanigans-like-never-before.jpg" alt="Shoes" /></figure>
                    <div className="card-body">
